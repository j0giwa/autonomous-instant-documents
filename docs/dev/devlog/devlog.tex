...
\begin{figure}[!htbp]
\centering
\includegraphics[width=250px]{../technical_documentation/gui_sketches/inspiration/opera.png}
\caption{\label{opera}Userinterface von Opera GX}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=250px]{../technical_documentation/gui_sketches/inspiration/gamma.png}
